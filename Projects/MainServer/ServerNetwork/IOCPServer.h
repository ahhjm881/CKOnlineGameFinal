...
public:
	...
	virtual void OnReceive(const UINT32 clientIndex_, google::protobuf::Arena& arena , const UINT32 size_, char* pData_) {}
...
private:
	...
	void WokerThread()
	{
		...
		while (mIsWorkerRun)
		{
			...
			{
				OnReceive(pClientInfo->GetIndex(), pClientInfo->GetArena(), dwIoSize, pClientInfo->RecvBuffer());
